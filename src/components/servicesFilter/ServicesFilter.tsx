  ...
  return (
    ...
    <div className='flex flex-col md:flex-row mt-10'>
      <div className='md:mt-10'>
        <h1 className='text-4xl md:text-5xl lg:text-[76px] font-semibold leading-tight md:leading-snug max-w-[976px]'>
          HOME AND GARDEN MASTERS
        </h1>
        <p className='text-base md:text-lg lg:text-xl w-full md:max-w-[740px] lg:w-[610px]'>
