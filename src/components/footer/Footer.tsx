          ...
          <footer className='my-16 mb-6'>
               <Container className="flex flex-col items-center">
                    ...
                    <div className='border border-black max-w-[450px] w-full flex item-center overflow-hidden pl-2 rounded-full'>
                         <input type="text" value={proposal} onChange={(e) => setProposal(e.target.value)} className="outline-none w-full border-none placeholder:text-sm text-sm text-gray-500 placeholder:font-light p-2" placeholder="Submit your proposal" />
                         <button onClick={handleSubmit} className='bg-black text-white px-8 py-2 rounded-full'> {sending ? 'Sending...' : 'Submit'}</button>
                    </div>
