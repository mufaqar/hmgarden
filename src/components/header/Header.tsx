               ...
               <header className={`mt-6 z-50 ${white ? 'text-white' : 'text-black'}`}>
                    ...
                    `}>
                              ...
                              <div className={`lg:hidden flex gap-3`}>
                                   <Link href="tel:07468602556" className={`border p-2 px-5 border-white !text-white `}>07468602556</Link>
                         ...
                         <div className='font-light z-40 lg:flex gap-4 hidden'>
                              <Link href="tel:07468602556" className={`border p-1 px-4 ${white ? 'border-white !text-white' : 'border-black'}`}>07468602556</Link>
