  ...
  return (
   <main className='container mx-auto px-4'>
    <div className='items-center justify-center'>
        <div>
           <h2 className='text-[48px] font-[600] text-center mt-10'>Top Rated Cleaning Services in the UK</h2>
        </div>

        <div className='flex flex-col-reverse lg:flex-row mt-10 items-center'>
